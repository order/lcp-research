...
#python simulate_policy_vs_value_estimate.py $CHEAP.vfn $CHEAP.q.policy $ROOT.prob $CHEAP.q.sim
...
#python simulate_policy_vs_value_estimate.py $CHEAP.vfn $CHEAP.flow.policy $ROOT.prob $CHEAP.flow.sim
...
# MCTS
#python form_mcts_policy.py $CHEAP.sol $CHEAP.disc $CHEAP.mdp $ROOT.prob $MCTS.policy -z25 -b100
#python simulate_policy_vs_value_estimate.py $CHEAP.vfn $MCTS.policy $ROOT.prob $MCTS.sim
#python compare_plot.py $MCTS.sim $ROOT.prob $MCTS.png -t"MCTS Return vs Value"

# Handcrafted
python form_handcraft_policy.py $HAND.policy
python simulate_policy_vs_value_estimate.py $CHEAP.vfn $HAND.policy $ROOT.prob $HAND.sim -s75 -r1500
python compare_plot.py $HAND.sim $ROOT.prob $HAND.png -t"Handcrafted Return vs Value"
