...
# Choices
from gens.pendulum_discretizer import HillcarGenerator as InstanceGenerator
...
if __name__ == '__main__':
    ...
    save_file = 'data/hillcar_kojima_traj' #.format(time_str) # no extension
    param_save_file = save_file + '.pickle'

    # Build the discretizer
    params = {'x_desc':(-15,15,xn),\
              'v_desc':(-5,5,dqn),\
              'a_desc':(-1,1,an)}
