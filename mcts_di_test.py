...
# Build problem
prob_build_fn = lambda: config.mdp.make_di_problem()
...
mdp_build_fn = lambda: config.mdp.make_uniform_mdp(problem,
                                                   nodes,
                                                   action_n)
...
#policy_dict['hand'] = BangBangPolicy()
rollout_policy = BangBangPolicy()
...
"""
start_states = np.ones((num_start_states,2))
